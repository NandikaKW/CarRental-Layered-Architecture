...
public class RentPaymentDetailsController  implements Initializable {
    ...
    void btnDeleteOnAction(ActionEvent event) throws SQLException, ClassNotFoundException, SQLException {
        ...
        if (optionalButtonType.isPresent() && optionalButtonType.get() == ButtonType.YES) {
            try {
                ...
                boolean isDeleted = rentPaymentBO.deleteRentPayment(rentId, paymentId);
    ...
    private void refreshTableData() {
        try {
            ArrayList<RentPayemntDto> rentPayemntDtos = (ArrayList<RentPayemntDto>) rentPaymentBO.getAllRentPayments();
    ...
    void btnSaveOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            boolean isSaved = rentPaymentBO.saveRentPayment(rentPayemntDto);
            if (isSaved) {
    ...
    void btnSearchOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            RentPayemntDto rentPayemntDto = rentPaymentBO.searchRentPayment(rentId, paymentId);
    ...
    void btnUpdateOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            boolean isUpdated = rentPaymentBO.updateRentPayment(rentPayemntDto);
    ...
    private void loadTableData() {
        try {
            ...
            for (RentPayemntDto rentPayemntDto : rentPayemntDtos) {
                // Debugging log to ensure data is valid
            ...
            tblRentPayment.setItems(rentPaymentTMs); // Set data to the TableView
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();

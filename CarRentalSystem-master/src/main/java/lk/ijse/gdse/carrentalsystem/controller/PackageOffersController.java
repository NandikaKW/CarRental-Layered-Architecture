...
public class PackageOffersController  implements Initializable {
    ...
    void btnDeleteOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        if (optionalButtonType.isPresent() && optionalButtonType.get() == ButtonType.YES) {
            try {
                ...
                boolean isDeleted = packageBO.delete(packageId);
    ...
    void btnSaveOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            boolean isSaved = packageBO.save(dto);
    ...
    void btnSearchAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            PackageDto dto = packageBO.search(packageId);
    ...
    void btnUpdateOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        try {
            boolean isUpdated = packageBO.update(dto);

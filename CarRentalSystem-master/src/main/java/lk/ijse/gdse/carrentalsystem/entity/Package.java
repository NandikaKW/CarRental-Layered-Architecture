...
public class Package {
    ...
    public Package(String packageId, String packageName, BigDecimal totalCost, boolean insuranceIncluded, String rentalDuration, Date rentDate, String mileageLimit, String description) {

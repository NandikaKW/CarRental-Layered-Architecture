...
public class VehicleRentDetailsController  implements Initializable {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        if (optionalButtonType.isPresent() && optionalButtonType.get() == ButtonType.YES) {
            try {
                ...
                boolean isDeleted = vehicleRentDetailBO.deleteVehicleRent(rentId, vehicleId);
                if (isDeleted) {
    ...
    private void refreshTableData() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<VechileRentDetailDto> vechileRentDetailDtos = vehicleRentDetailBO.getAllVehicleRentDetails();

...
public class RentAgrimentController implements Initializable {
    ...
    void btnDeleteOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        if (optionalButtonType.isPresent() && optionalButtonType.get() == ButtonType.YES) {
            try {
                ...
                boolean isDeleted = agrimentBO.deleteAgriment(agrimentId);
    ...
    public void refreshTableData() throws SQLException, ClassNotFoundException {
        ArrayList<AgrimentDto> agrimentDtos = agrimentBO.getAllAgriments();
    ...
    void btnSearchOnAction(ActionEvent event) {
        ...
        try {
            ...
            AgrimentDto agrimentDto = agrimentBO.searchAgriment(agrimentId);
    ...
    void btnUpdateOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        try {
            ...
            boolean isUpdated = agrimentBO.updateAgriment(agrimentDto);
    ...
    public void loadNextAgrimentId() throws SQLException, ClassNotFoundException {
        try {
            ...
            String nextAgrimentId = agrimentBO.getNextAgreementId();
